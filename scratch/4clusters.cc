...
int main(int argc, char *argv[])
{
	...
	if (sourceData.GetN() < nNodes * 4)
		cout << "The input matrix " << srcMatrixName << "does not have enough columns for " << to_string(4 * nNodes) << " Nodes" << endl;
